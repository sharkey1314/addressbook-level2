    ...
    public TypicalPersons() {
        try {
            amy = new Person(new Name("Amy Buck"), new Phone("91119111", false), new Email("ab@gmail.com", false),
                    new Address("Jurong West St 91, Blk 950, #05-621, S640950", false), new UniqueTagList());
            bill = new Person(new Name("Bill Clint"), new Phone("92229222", false), new Email("bc@gmail.com", false),
                    new Address("2 Clementi Road, Blk 304, #11-11, S101010", false), new UniqueTagList());
            candy = new Person(new Name("Candy Destiny"), new Phone("93339333", false),
                    new Email("cd@gmail.com", false), new Address("3 Clementi Road, Blk 88, #11-22, S101232", false), new UniqueTagList());
